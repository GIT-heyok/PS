...
3. it is an same edit distance thing but there are more conditions
in checking two characters.
*/
...
int main(){
    ...
    for (int i = 1; i <= in_sz; i++)
    {
        ...
        {
            if(input[i-1]==target[j-1]||(input[i-1]=='v'&&target[j-1]=='w')||(input[i-1]=='i'&&(target[j-1]=='j'||target[j-1]=='l'))){
